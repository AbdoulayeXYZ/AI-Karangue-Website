...
export const ShareButtons = ({ title }: ShareButtonsProps) => {
    ...
    return (
        <aside className="lg:w-48 flex lg:flex-col gap-4 sticky top-40 h-fit order-2 lg:order-1">
            <div className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20 mb-4 hidden lg:block">PARTAGER</div>

            <button
                onClick={shareOnLinkedIn}
                className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-teal hover:border-teal transition-all duration-500 group"
            >
                <Linkedin className="w-5 h-5 text-white/40 group-hover:text-white transition-colors" />
                <span className="text-[9px] font-black uppercase tracking-widest text-white/20 group-hover:text-white hidden lg:block">LinkedIn</span>
            </button>
            ...
            >
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-white/20 group-hover:text-white hidden lg:block">Facebook</span>
            </button>
            ...
            >
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-white/20 group-hover:text-white hidden lg:block">WhatsApp</span>
            </button>
        </aside>
    );
};

...
async function updatePost() {
    console.log('Updating blog post with tables, no emojis, text-justify styles...');
...
<div class="overflow-x-auto my-8"><table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden text-left"><thead class="bg-navy text-white text-left"><tr><th colspan="2" class="py-3 px-4 font-bold">Exemple calculé : Flotte de 20 véhicules légers/commerciaux à Dakar</th></tr></thead><tbody class="text-navy divide-y divide-gray-200"><tr><td class="py-3 px-4 font-semibold">Consommation moyenne</td><td class="py-3 px-4">12 litres / 100 km</td></tr><tr class="bg-gray-50"><td class="py-3 px-4 font-semibold">Distance mensuelle par véhicule</td><td class="py-3 px-4">3 000 km <em>(estimation standard pour usage urbain et péri-urbain Dakar - régions)</em></td></tr><tr><td class="py-3 px-4 font-semibold">Consommation totale flotte</td><td class="py-3 px-4">20 × 3 000 × 0,12 = <strong>7 200 litres/mois</strong></td></tr><tr class="bg-teal/10"><td class="py-3 px-4 font-semibold">Facture carburant mensuelle</td><td class="py-3 px-4 font-bold text-teal">7 200 × 680 = 4 896 000 FCFA</td></tr><tr class="bg-navy/5"><td class="py-3 px-4 font-semibold">Facture annuelle</td><td class="py-3 px-4 font-black text-navy border-t-2 border-navy">58 752 000 FCFA <em>(soit environ 89 600 €)</em></td></tr></tbody></table></div>
...
<div class="overflow-x-auto my-8"><table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden text-sm md:text-base text-left"><thead class="bg-navy text-white text-left"><tr><th class="py-3 px-4 font-bold">Scénario</th><th class="py-3 px-4 font-bold">Litres perdus/mois</th><th class="py-3 px-4 font-bold">Coût mensuel perdu</th><th class="py-3 px-4 font-bold">Coût annuel perdu</th></tr></thead><tbody class="text-navy divide-y divide-gray-200"><tr><td class="py-3 px-4 font-semibold">Perte de 5% (seuil bas)</td><td class="py-3 px-4">360 litres</td><td class="py-3 px-4 font-bold text-red-500">244 800 FCFA</td><td class="py-3 px-4 font-black">2 937 600 FCFA</td></tr><tr class="bg-gray-50"><td class="py-3 px-4 font-semibold">Perte de 8% (seuil moyen)</td><td class="py-3 px-4">576 litres</td><td class="py-3 px-4 font-bold text-red-500">391 680 FCFA</td><td class="py-3 px-4 font-black">4 700 160 FCFA</td></tr><tr><td class="py-3 px-4 font-semibold">Perte de 10% (seuil haut)</td><td class="py-3 px-4">720 litres</td><td class="py-3 px-4 font-bold text-red-500">489 600 FCFA</td><td class="py-3 px-4 font-black">5 875 200 FCFA</td></tr></tbody></table><p class="text-sm text-gray-500 italic mt-2">Calcul basé sur : 7 200 litres/mois × taux de perte × 680 FCFA/litre (tarif officiel CRSE, décembre 2025)</p></div>
...
### Traçage GPS des itinéraires réels : Fin des détours fantômes
...
### Scoring comportemental conducteur : Attaquer le gaspillage à la source
...
<div class="overflow-x-auto my-8"><table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden text-left"><thead class="bg-teal text-white"><tr><th class="py-3 px-4 text-left font-bold">Concept</th><th class="py-3 px-4 text-left font-bold">Montant / Impact</th></tr></thead><tbody class="text-navy divide-y divide-gray-200"><tr><td class="py-3 px-4 font-semibold">Pertes estimées carburant (8% / an)</td><td class="py-3 px-4">4 700 000 FCFA</td></tr><tr class="bg-gray-50"><td class="py-3 px-4 font-semibold">Économies conduite optimisée (12%)</td><td class="py-3 px-4">7 056 000 FCFA</td></tr><tr class="bg-red-50"><td class="py-3 px-4 font-semibold text-red-600">Total pertes / gaspillage potentiel</td><td class="py-3 px-4 font-bold text-red-600">~11 750 000 FCFA / an</td></tr><tr><td class="py-3 px-4 font-semibold">Abonnement Karangué 221 (20 véhicules)</td><td class="py-3 px-4">À définir selon formule</td></tr><tr class="bg-green-50"><td class="py-3 px-4 font-black text-green-700">Retour sur investissement</td><td class="py-3 px-4 font-black text-green-700">Dès le 1er trimestre</td></tr></tbody></table><p class="text-sm text-gray-500 italic mt-2">Calcul basé sur : 7 200 litres/mois × 8% × 680 FCFA × 12 mois pour les pertes vol ; économies conduite calculées sur la consommation totale annuelle de 86 400 litres.</p></div>
...
<div class="overflow-x-auto my-8"><table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden text-left"><thead class="bg-navy text-white"><tr><th colspan="2" class="py-3 px-4 text-left font-bold">Calculated Example : Fleet of 20 light/commercial vehicles in Dakar</th></tr></thead><tbody class="text-navy divide-y divide-gray-200"><tr><td class="py-3 px-4 font-semibold">Average consumption</td><td class="py-3 px-4">12 liters / 100 km</td></tr><tr class="bg-gray-50"><td class="py-3 px-4 font-semibold">Monthly distance per vehicle</td><td class="py-3 px-4">3,000 km <em>(standard estimate for urban and peri-urban Dakar-regions usage)</em></td></tr><tr><td class="py-3 px-4 font-semibold">Total fleet consumption</td><td class="py-3 px-4">20 × 3,000 × 0.12 = <strong>7,200 liters/month</strong></td></tr><tr class="bg-teal/10"><td class="py-3 px-4 font-semibold">Monthly fuel bill</td><td class="py-3 px-4 font-bold text-teal">7,200 × 680 = 4,896,000 FCFA</td></tr><tr class="bg-navy/5"><td class="py-3 px-4 font-semibold">Annual bill</td><td class="py-3 px-4 font-black text-navy border-t-2 border-navy">58,752,000 FCFA <em>(approximately 89,600 €)</em></td></tr></tbody></table></div>
...
<div class="overflow-x-auto my-8"><table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden text-sm md:text-base text-left"><thead class="bg-navy text-white text-left"><tr><th class="py-3 px-4 font-bold">Scenario</th><th class="py-3 px-4 font-bold">Liters lost/month</th><th class="py-3 px-4 font-bold">Monthly cost lost</th><th class="py-3 px-4 font-bold">Annual cost lost</th></tr></thead><tbody class="text-navy divide-y divide-gray-200"><tr><td class="py-3 px-4 font-semibold">5% loss (low threshold)</td><td class="py-3 px-4">360 liters</td><td class="py-3 px-4 font-bold text-red-500">244,800 FCFA</td><td class="py-3 px-4 font-black">2,937,600 FCFA</td></tr><tr class="bg-gray-50"><td class="py-3 px-4 font-semibold">8% loss (mid threshold)</td><td class="py-3 px-4">576 liters</td><td class="py-3 px-4 font-bold text-red-500">391,680 FCFA</td><td class="py-3 px-4 font-black">4,700,160 FCFA</td></tr><tr><td class="py-3 px-4 font-semibold">10% loss (high threshold)</td><td class="py-3 px-4">720 liters</td><td class="py-3 px-4 font-bold text-red-500">489,600 FCFA</td><td class="py-3 px-4 font-black">5,875,200 FCFA</td></tr></tbody></table><p class="text-sm text-gray-500 italic mt-2">Calculation based on: 7,200 liters/month × loss rate × 680 FCFA/liter (official CRSE rate, December 2025)</p></div>
...
### GPS Tracking of Actual Routes : End of Phantom Detours
...
### Driver Behavioral Scoring : Attacking Waste at the Source
...
<div class="overflow-x-auto my-8"><table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden text-left"><thead class="bg-teal text-white"><tr><th class="py-3 px-4 text-left font-bold">Concept</th><th class="py-3 px-4 text-left font-bold">Amount / Impact</th></tr></thead><tbody class="text-navy divide-y divide-gray-200"><tr><td class="py-3 px-4 font-semibold">Estimated fuel losses (8%/yr)</td><td class="py-3 px-4">4,700,000 FCFA</td></tr><tr class="bg-gray-50"><td class="py-3 px-4 font-semibold">Optimized driving savings (12%)</td><td class="py-3 px-4">7,056,000 FCFA</td></tr><tr class="bg-red-50"><td class="py-3 px-4 font-semibold text-red-600">Total potential losses/waste</td><td class="py-3 px-4 font-bold text-red-600">~11,750,000 FCFA/yr</td></tr><tr><td class="py-3 px-4 font-semibold">Karangué 221 subscription (20 vehicles)</td><td class="py-3 px-4">TBD based on plan</td></tr><tr class="bg-green-50"><td class="py-3 px-4 font-black text-green-700">Return on Investment</td><td class="py-3 px-4 font-black text-green-700">From the 1st quarter</td></tr></tbody></table><p class="text-sm text-gray-500 italic mt-2">Calculation based on: 7,200 liters/month × 8% × 680 FCFA × 12 months for theft losses; driving savings calculated on the total annual consumption of 86,400 liters.</p></div>
